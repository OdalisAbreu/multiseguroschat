...
class AdminController extends Controller
{
    public function CreateClient()
    {
        ...
        return Inertia::render('AdminPages/Vender/Unico/CreateClient', [
            'cities' => $cities,
            'provinces' => $provinces,
        ]);
    }

    public function AddClientCar(Request $request, $marcaid) //Vista 2 Vehiculos
    {
        ...
        $seller = DB::table('insurances')
            ...
            ->get();
        return Inertia::render('AdminPages/Vender/Unico/SelectPolicy', [
            'car' => $car,
            'sellers' => $seller,
    ...
    public function services($insurresId, $time, Request $request) //VISTA 3 ASEGURADORA
    {
        ...
        return Inertia::render('AdminPages/Vender/Unico/SelectService', [
            'car' => $request->car,
    ...
    public function  confirmPolice(Request $request) //VISTA 4 SERVICIOS
    {
        $services = array();
        $totalServicios = 0;
        ...
        return Inertia::render('AdminPages/Vender/Unico/ConfirmPolice', [
            'car' => $car,
    ...
    public function CreateEmpresa()
    {
        $cities = Municipalities::orderBy('descrip')->get();
        $provinces = Province::orderBy('descrip')->get();
        return Inertia::render('AdminPages/Vender/Varios/AddEmpresa', [
            'cities' => $cities,
            'provinces' => $provinces,
        ]);
    }
