    ...
    public function statusPayment(Request $request){
        ...
        if($request->decision == 'ACCEPT'){
            ...
            $servicio = json_decode($invoices->services);
                ...
                $poliza = Http::withToken($token['token'])->post('http://multiseguros.com.do:5050/api/Seguros/Policy', [
                ...
                'insured' => [
                    "name" => "ODalis",
                    "lastName" => "Abreu",
                    "identificationCardNumber" => "22400274092",
                    "passportNumber" => "'.$passportnumber.'",
                    "emailAddress" => "dariel@mail.com",
                    "phoneNumber" => $phonenumber,
                    "residenceAddress" => "Las palmas",
