<template>
    <div class="bg-blue-700 mb-3">
        <div class="flex flex-col justify-center bg-blue-700">

            <div class="justify-self-center self-center overflow-x-hidden border-t flex flex-col bg-blue">
                <div class="p-2">
                    <img class="h-12 w-25" src="/ima/sc2_ic.png" alt="Logo" />
                </div>
            </div>

            <div class="flex justify-around text-sm bg-blue-700 mt-2 text-white mb-2">
                <p>Asegurado</p>
                <p>Póliza</p>
                <p>Aseguradora</p>
                <p>Pago</p>
            ...
            <div class="mx-3 sm:mx-20 lg:mx-20 xl:mx-20">
                <div class="bg-slate-800 opacity-50 rounded-full">
                    <div class="bg-blue-400 text-xs font-medium text-blue-100 text-center p-1 leading-none rounded-l-full"
                        :style="{ width: width + '%' }">
                    </div>
                </div>
            </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="absolute z-0">
            <path fill="rgb(29 78 216)" fill-opacity="1"
