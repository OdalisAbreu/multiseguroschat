    ...
    <section class="bg-gray-200 pb-6 h-full" :class="{ 'animate-pulse': Loading, 'opacity-50': Loading }">
        ...
        <section class="p-3 relative rounded-xl bg-white mx-3 z-50 mt-4">
            ...
            <div
                ...
                <p>Descuento: ${{ new Intl.NumberFormat('en-IN').format(form3.descontar) }}.00</p>
                <p>Total a pagar: ${{ new Intl.NumberFormat('en-IN').format(form3.totalGeneral) }}.00</p>
            </div>
            ...
            <div class="w-full font-bold text-center py-4 text-lg">
                <h3>Realizara el pago en la plataforma de CardNet</h3>
            </div>
            <!-- <div class="w-full font-bold overflow-x-hidden border-t flex gap-2 text-base justify-center pb-4">
                <p>Total a pagar: RD${{ new Intl.NumberFormat('en-IN').format(form3.totalGeneral) }}.00</p>
            </div> -->
