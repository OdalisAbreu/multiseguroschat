    ...
    <section class="h-screen w-screen bg-white">
        ...
        <main class="relative bg-white max-w-lg p-8 mt-10 shadow-2xl w-screen mx-auto">
            <div class="text-center">
                <h3 class="font-bold text-2xl text-center">Para procesar tu pago de manera segura pulsa Continuar
                </h3>
                <img class="inline" src="/ima/secutity.png" alt="Cards">
            </div>
            <form action="https://testsecureacceptance.cybersource.com/pay" method="post">
                ...
                <input type="hidden" id="signed_field_names" name="signed_field_names"
                    value="merchant_defined_data1,merchant_defined_data2,merchant_defined_data3,merchant_defined_data30,access_key,profile_id,transaction_uuid,signed_field_names,unsigned_field_names,signed_date_time,locale,transaction_type,reference_number,amount,currency,override_custom_cancel_page,override_custom_receipt_page" />
                ...
                <input type="hidden" id="override_custom_cancel_page" name="override_custom_cancel_page"
                ...
                <input type="hidden" id="merchant_defined_data30" name="merchant_defined_data30"
                    v-model="form.client_id">

                <div class="flex flex-col">
                    <button
                        class="bg-lime-600 hover:bg-lime-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200">Continuar</button>
                </div>
            </form>
        </main>
    </section>
