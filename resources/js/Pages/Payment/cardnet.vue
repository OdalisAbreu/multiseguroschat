        ...
        >
            ...
            <div class="text-center">
                <h3 class="font-bold text-2xl text-center">
                    Pulsa <i>CONTINUAR</i><br />
                    para procesar tu pago de manera segura
                </h3>
                <h4 class="font-bold text-2xl text-center text-red-900">
                    <i>Seguros chat no guarda información de tu tarjera </i>
                </h4>
                <img
                    class="inline pb-4 pt-4 max-w-xs"
                    src="ima/cardnetLogo.png"
                />
...
export default {
    ...
    methods: {
        ...
        sendPayment() {
            ...
            axios
                .post(this.paymentUrl, this.form)
                .then((response) => {
                    // Handle the response
